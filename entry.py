...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=['16', '32', 'bf16'],
        default=None,
        help='Floating point precision: 16 for fp16, 32 for fp32, bf16 for bfloat16 (overrides config)'
    )
    parser.add_argument(
        '--epochs',
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help='Batch size (overrides config; if null, auto-estimated based on GPU memory)'
    )
    parser.add_argument(
        '--learning-rate',
        type=float,
