...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x, attention_mask=None):
        ...
        # if a mask is passed, we disable causality.
...
class GPTModel(nn.Module):
    ...
    def forward(self, x, targets=None, attention_mask=None, task_name=None, spans=None, correct_idx=None, p_star=None, tau=0.1, m_star=None, c_true=None, l_true=None):
        ...
        # Apply transformer blocks, passing in our mask
        # if no mask provided, attention just uses causal or full as before
        for block in self.blocks:
            x_embed = block(x_embed, attention_mask)
