...
def flash_attention_backward_setup_context(ctx, q, k, v, lens, sm_scale, autotune, return_lse, prescale_qk, precision):
    ...
    # Return value from the forward pass that will be used in the backward pass
    return (q, k, v, lens)
