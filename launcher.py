...
def run_training(config: dict):
    ...
    """
    print("--- Starting training script in Modal ---")
...
def main():
    ...
    """
    print("--- Preparing and launching Modal job ---")
    ...
    # 3. Run the remote function
    print("Launching Modal job...")
    run_training.remote(config=config)
    print("--- Modal job finished ---")